...
class Home extends Component<{}, HomeState> {
  ...
  updateTerminalState(isOpen: boolean) {
    this.setState({
      isTerminalOpened: isOpen,
    });
  }

  homeClassName() {
    let className = 'home';
    if (!this.state.isTerminalEnabled || !this.state.isTerminalOpened) {
      return className;
    }
    return `${className} home-hidden`;
  }
  ...
  render() {
    return (
      <div className="cle">
        ...
        <div className={this.homeClassName()}>
          <div className="logo">
            <img src="/cle.png" />
          </div>
          <div className="info">
        ...
        { this.state.isTerminalEnabled ? (
          <Shell
            isOpen={this.state.isTerminalOpened}
            toggleTerminal={this.updateTerminalState.bind(this)}
          />
